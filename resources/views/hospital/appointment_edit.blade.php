    ...
    <form action="{{ url('appointment/'.$appointments->id.'/edit') }}" method="POST">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="number" name="availabilities_id" value= "{{$appointments->availabilities_id}}" class="form-control" id="patientName" placeholder="Enter patient name" required>
            </div>
            <div class="form-group col-md-6">
                <label for="age">Doctor Id</label>
                <input type="number" name="doctor_id" value= "{{$appointments->doctor_id}}" class="form-control" id="age" placeholder="Enter age" required>
            </div>
            <div class="form-group col-md-6">
                <label for="age">Patient Id</label>
                <input type="number" name="patient_id" value= "{{$appointments->patient_id}}" class="form-control" id="age" placeholder="Enter age" required>
            </div>
            <div class="form-group col-md-6">
                <label for="phone">Diease Id</label>
                <input type="number" name="diease_id" value= "{{$appointments->diease_id}}" class="form-control" id="phone" placeholder="Enter phone number" required>
            </div>
        </div>
